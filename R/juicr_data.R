...
#'    \code{readImage(system.file("images", "Kam_et_al_2003_Fig2.jpg", package = "juicr"))}
NULL
...
#' @format A raw jpg-formated image
#' @note \strong{How to use}\cr\cr 
#'    \code{readImage(system.file("images", "Kortum_and_Acymyan_2013_Fig4.jpg", package = "juicr"))}
NULL